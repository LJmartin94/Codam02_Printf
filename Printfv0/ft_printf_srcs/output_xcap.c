...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/02/12 03:58:37 by limartin          #+#    #+#             */
/*   Updated: 2020/02/13 03:16:40 by limartin         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int				ft_outxcap(va_list ap, t_input info)
{
	...
	type.xcap = va_arg(ap, unsigned int);
	len = ft_getlen(type.xcap, info);
	ret = len;
